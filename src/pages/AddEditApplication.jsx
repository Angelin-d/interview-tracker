    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-slate-400
              uppercase tracking-widest mb-1.5">Status</label>
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-400
              uppercase tracking-widest mb-1.5">Date Applied *</label>
          ...
          />
            {errors.dateApplied && <p className="text-red-400 text-xs mt-1">{errors.dateApplied}</p>}
          </div>
        </div>
        ...
        <div>
          ...
          <textarea rows={3} placeholder="e.g. Passed OA. HR round next week."
            value={form.notes}
